        ...
        <form id="create-form">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="job_title" placeholder="Enter Job name">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="job_region" placeholder="Enter Job region">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control job_type" id="job_type">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" id="salary" placeholder="Enter Salary in USD"
                            min="0" title="Please enter a positive number" aria-describedby="salaryHelp">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control experience" id="experience">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="jobdescription" rows="5" placeholder="Enter Job Description"></textarea>
                </div>
                <div class="form-group">
                    <label for="responsibilities">Responsibilities</label>
                    <textarea class="form-control" id="responsibilities" rows="5" placeholder="Enter Job Responsibilities"></textarea>
                </div>
                <div class="form-group">
                    <label for="education_experience">Education Experience</label>
                    <textarea class="form-control" id="education_experience" rows="5"
                        placeholder="Enter Your Educational Experience"></textarea>
                </div>
                <div class="form-group">
                    <label for="other_benifits">Other Benefits</label>
                    <textarea class="form-control" id="other_benifits" rows="5" placeholder="Enter Other Benefits"></textarea>
                </div>
...
@section('script')
    ...
    <script>
        ...
        function store() {
            ...
            axios.post('/admin/dashboard/jobs', formData)
